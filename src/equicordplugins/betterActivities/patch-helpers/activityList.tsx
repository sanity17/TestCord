...
function ActivityListInner({ activities: rawActivities, user, hideTooltip }: ActivityListProps): JSX.Element | null {
...
export function patchActivityList(props: ActivityListProps): JSX.Element {
